...
contract("Fundraiser", (accounts) => {
  ...
  describe("making donations", () => {
    ...
    it("increases myDonatationsCount", async () => {
  ...
  describe("wthdrawing funds", () => {
    ...
    describe('access controls', () => {
      ...
      it("permits the owner to call the function", async () => {
        try {
          ...
          assert.fail("should not have throw an error");
        }
      });
      ...
      it("transfers balance to beneficiary", async () => {
        ...
        const beneficaryDifference = newBeneficiaryBalance - currentBeneficiaryBalance;

        assert.equal(newContractBalance, 0, "contract should have a 0 balance");
        assert.equal(
          beneficaryDifference, currentContractBalance, "beneficiary should receive all the funds"
        );
      });
    ...
    describe("fallback function", () => {
      ...
      it("increases donationsCount", async() => {
        ...
        assert.equal(
          1, newDonationsCount - currentDonationsCount, "donationsCount should increment by 1"
        );
      });
    });
  });
